...
class AdminPostController extends AdminbaseController {
	...
	function add_post(){
		if (IS_POST) {
			...
			if (empty($_POST['post']['post_keywords'])){
				$_POST['post']['post_keywords'] = "空1";
			}
			if (empty($_POST['post']['post_source'])){
				$_POST['post']['post_source'] = "空2";
			}
			if (empty($_POST['post']['post_modified'])){
				$_POST['post']['post_modified'] = date("Y-m-d H:i:s");
			}
			if (empty($_POST['post']['post_status'])){
				$_POST['post']['post_status'] = 1;
			}
			if (empty($_POST['post']['istop'])){
				$_POST['post']['istop'] = 0;
			}
